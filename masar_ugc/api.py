...
def get_item_details():
    return frappe.db.sql("""
                         SELECT 
                            ...
                            custom_applicationtool_3_ar , custom_applicationtool_3_fr , custom_friendly_url,  IFNULL(CONCAT('https://ugc.kcsc.com.jo', image), NULL) AS image_url
                        FROM tabItem ti
...
def get_system_master():
    systems = frappe.db.sql("""
        SELECT 
            ...
            system_description_en, system_description_ar, system_description_fr, IFNULL(CONCAT('https://ugc.kcsc.com.jo', image), NULL) AS image_url
